...
O conteúdo desta chamada (matriz) descreve o produto, a data de lançamento e a relação oficina · loja. A loja (caracore-ru-releases) está no ar: vitrine, download, licença, manual técnico e canal de feedback em https://ru.caracore.com.br/ (domínio institucional; espelho GitHub Pages com pasta docs/).

## Produto

- **RU Soberano:** simulador de reator catalítico PFR com cinética Langmuir-Hinshelwood, console de engenharia, Data Sheet técnico (RMSE), snapshot de estado e relatório de operação de unidade piloto. Kernel de cálculo para fins profissionais; uso sob responsabilidade do operador (ver disclaimer no aplicativo).
...
| `MIRROR_DELIVERY.md` | Este arquivo: regras de espelho e alinhamento para lançamento. |
